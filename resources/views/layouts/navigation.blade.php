        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <button x-data="{ dark: document.documentElement.classList.contains('dark') }" 
                        ...
                        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full p-2 mr-2 focus:outline-none transition-colors"
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                <button x-data="{ dark: document.documentElement.classList.contains('dark') }" 
                        @click="dark = !dark; document.documentElement.classList.toggle('dark', dark); localStorage.setItem('theme', dark ? 'dark' : 'light')" 
                        class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md p-2 mr-1 focus:outline-none transition duration-150 ease-in-out"
                        title="Toggle Dark Mode">
